...
$response = Invoke-RestMethod 'https://console.us1.crashplan.com/api/v1/Role' -ContentType "application/json" -Method 'GET' -Headers $headers
...
$add1 = "INSERT INTO JSON_CrashPlan ( JSON_Date, DATASET, JSON_Data ) VALUES ('" + $RunTime + "', 'ROLES', '" + $responseObj + "')"
