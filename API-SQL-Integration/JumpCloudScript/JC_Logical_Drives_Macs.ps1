...
# Save info
$response = Get-JCSystemInsights -Table:('UsbDevice')

# Convert to JSON
$responseObj = ConvertTo-Json $response

$add1 = "INSERT INTO JSON_JumpCloud ( JSON_Date, DATASET, JSON_Data ) VALUES ('" + $RunTime + "', 'Logical_Drives_Mac', '" + $responseObj + "')"
