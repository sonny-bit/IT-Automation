...
# Save info
$response = Get-JCGroup -Type User | Get-JCUserGroupMember
$response[0]

# Convert to JSON
$responseObj = ConvertTo-Json $response

$add1 = "INSERT INTO JSON_JumpCloud ( JSON_Date, DATASET, JSON_Data ) VALUES ('" + $RunTime + "', 'USER_GROUPS', '" + $responseObj + "')"
