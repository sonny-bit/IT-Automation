...
$url = 'https://console.jumpcloud.com/api/v2/systeminsights/mounts?limit=10000'
...
$add1 = "INSERT INTO JSON_JumpCloud ( JSON_Date, DATASET, JSON_Data ) VALUES ('" + $RunTime + "', 'JC_MOUNTS_MAC', '" + $responseObj + "')"
