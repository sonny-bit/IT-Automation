...
$url = 'https://console.jumpcloud.com/api/v2/systeminsights/interface_details?limit=10000'

$response = Invoke-RestMethod -Uri $url -Method 'GET' -Headers $headers

if ($response -eq $null) {
    Write-Host "No data detected... exiting 1"
    exit 1
}
...
$add1 = "INSERT INTO JSON_JumpCloud ( JSON_Date, DATASET, JSON_Data ) VALUES ('" + $RunTime + "', 'JC_Network_Interface', '" + $responseObj + "')"
