...
# Save info
$response = Get-JCPolicy -ErrorAction SilentlyContinue | Get-JCPolicyTargetSystem -ErrorAction SilentlyContinue
...
if ($response) {
    ...
    $add1 = "INSERT INTO JSON_JumpCloud ( JSON_Date, DATASET, JSON_Data ) VALUES ('" + $RunTime + "', 'JC_Policy_To_Devices', '" + $responseObj + "')"
